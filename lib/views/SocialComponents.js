...
import { ChatMessageForm, ChatMessageList, SocialCompConfig, } from "@commonmodule/social-components";
...
export default class SocialComponents extends View {
    constructor() {
        super();
        this.container = el(".showcase-view.social-components-view", el("h1", "Social Components")).appendTo(AppRoot);
        let messageList;
        this.container.append(el("section.chat", el("h2", "Chat"), messageList = new ChatMessageList(getTestChatHistory()), new ChatMessageForm((newMessage) => messageList.addMessage({
            id: uuidv4(),
            author: "user1",
            content: newMessage,
...
//# sourceMappingURL=SocialComponents.js.map