...
import { AppCompConfig, Button, ButtonGroup, ButtonType, Checkbox, DropdownMenu, DropdownMenuGroup, DropdownMenuItem, FileTree, Input, Select, Tab, TabGroup, } from "@commonmodule/app-components";
export default class AppComponents extends View {
    constructor() {
        ...
        this.container.append(el("section.navigation", el("h2", "Navigation"), el("section", el("h3", "Menu"), el(".button-container", new Button({
            ...
            label: "Tab 3",
            value: "tab3",
        })).selectTab("tab2")), el("section", el("h3", "File Tree"), new FileTree([{
                id: "1",
                name: "Root",
                type: "directory",
                children: [
        ...
        this.container.append(el("section.display", el("h2", "Display"), el("section", el("h3", "Alert")), el("section", el("h3", "Modal")), el("section", el("h3", "Dialog"))));
        this.container.append(el("section", el("h2", "Miscellaneous"), el("section", el("h3", "Accordion")), el("section", el("h3", "Image Viewer"))));
    }
}
